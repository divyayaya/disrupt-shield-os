  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "pulse-glow": {
          "0%, 100%": {
            boxShadow: "0 0 5px hsl(var(--electric) / 0.3)"
          },
          "50%": {
            boxShadow: "0 0 20px hsl(var(--electric) / 0.8)"
          }
        },
        "pulse-critical": {
          "0%, 100%": {
            boxShadow: "0 0 5px hsl(var(--critical) / 0.3)"
          },
          "50%": {
            boxShadow: "0 0 20px hsl(var(--critical) / 0.8)"
          }
        },
        "slide-up": {
          "0%": {
